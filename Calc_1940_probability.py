...
# # Trying it for 1-15 years stopping in 1942 (as the 1940)
# events = np.linspace(1,n_events,n_events,dtype=int)
# start_yrs = np.linspace(1942 - n_events + 1,1942,n_events,dtype=int)[::-1]
# stop_yrs = [1942]*n_events
...
def make_probability_fig(vname,cesm_thresh,pace_thresh,\
    ...
    plt.annotate('a)',(0.01,.86),xycoords = 'axes fraction',fontsize=fs+1,weight='bold')
    ...
    plt.annotate('b)',(0.01,.86),xycoords = 'axes fraction',fontsize=fs+1,weight='bold')
    ...
    ax1.annotate('c)',(0.01,.88),xycoords = 'axes fraction',fontsize=fs+1,weight='bold')
    ...
    ax2.annotate('d)',(0.01,.88),xycoords = 'axes fraction',fontsize=fs+1,weight='bold')
    ...
    if vname == 'psl':
        ax3.set_ylabel('Occurrences per 10kyr',labelpad=1.25)
        ax3.legend(fontsize=8,loc='upper center',ncol=1)
    else:
        ax3.set_ylabel('Occurrences per 10kyr',labelpad=3)
        ax3.legend(fontsize=8,loc='upper right',ncol=2)
    ax3.set_xlabel('Window Length (years)',labelpad=1)
    ax3.set_xticks(events)
    ax3.set_xlim([-0.5,n_events+.5])
    ax3.annotate('e)',(0.01,.88),xycoords = 'axes fraction',fontsize=fs+1,weight='bold')
    ...
    if vname == 'psl':
        ax5.set_ylabel('Occurrences per 10kyr',labelpad=0.5)#-0.5
    else:
        ax5.set_ylabel('Occurrences per 10kyr',labelpad=2)#1
    ax5.set_xlabel('Window Length (years)',labelpad=1)
    ax5.set_xticks(events)
    ax5.set_xlim([-0.5,n_events+.5])
    ax5.legend(fontsize=8,loc='upper right',ncol=2)
    ax5.annotate('f)',(0.02,.88),xycoords = 'axes fraction',fontsize=fs+1,weight='bold')
